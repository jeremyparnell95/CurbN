...
<body>
  ...
  <h3><strong>Is willing to pay $<u>5.00</u></strong></h3>
  <p>
    <button class = press onclick="window.location='request_page.php'">Back</button>
  	<button class = press onclick="window.location='main.php'">Accept</button>
    <button class = press onclick="window.location='main.php'">Deny</button>
  </p>
</body>
</html>